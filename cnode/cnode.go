...
import (
	...
	"github.com/celer-network/agent-pay/common/cobj"
	...
	"github.com/celer-network/agent-pay/dispatchers"
	...
	"github.com/celer-network/agent-pay/migrate"
...
func (c *CNode) dialOpts(drop bool) []grpc.DialOption {
	opts := []grpc.DialOption{
		utils.GetClientTlsOptionPermissive(), grpc.WithBlock(),
