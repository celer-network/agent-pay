...
4. [Backend Cross-Net](./backend-crossnet.md) for the off-chain cross-net forwarding design — net identity, bridge pair trust model, message flow, and operator config.
