...
// Deprecated: Use SimpleMultiSessionAppMetaData.ABI instead.
...
// Deprecated: Use SimpleMultiSessionAppMetaData.Bin instead.
...
func DeploySimpleMultiSessionApp(auth *bind.TransactOpts, backend bind.ContractBackend, _playerNum *big.Int) (common.Address, *types.Transaction, *SimpleMultiSessionApp, error) {
	parsed, err := SimpleMultiSessionAppMetaData.GetAbi()
	if err != nil {
